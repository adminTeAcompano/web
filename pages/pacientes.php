...
<body>
    ...
    <header class="hero">
        <h1 id="idd" class="titulo">TE<span>ACOMPAÑO</span></h1>
    </header>
    ...
    <main class="logistica">
        <section class="agregar">
            ...
            <button onclick="window.location.href='agregar.php'" type="submit">Agregar Paciente</button>
        </section>
        ...
        <section class="eliminar">
            ...
            <button onclick="window.location.href='eliminar.php'" type="submit">Eliminar Paciente</button>
        </section>
        ...
        <section class="buscar">
            ...
            <button onclick="window.location.href='busqueda.php'" type="submit">Buscar Paciente</button>
        </section>
